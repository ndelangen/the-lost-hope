...
export default createEvent({
  ...
  notes: [
    ...
    [
      'She described ',
      refs.pcs.swift_starblade,
      ' as a formerly good man who became a notorious plunderer. She claimed that he took her father’s ship and abducted her mother, and that he was searching for relatives scattered among islands near ',
    ...
    [
      ...
      refs.pcs.swift_starblade,
      '’s younger sister and bring her alive to ',
      refs.npcs.sylvia,
    ...
    [
      refs.npcs.sylvia,
      ' said a special magical suit of armour can be made by collecting twelve daggers like the ',
    ...
    [
      ...
      ' were present for ',
      refs.npcs.sylvia,
      '’s account, and they are the only party members who know about the quest. At the same time, ',
      refs.pcs.swift_starblade,
      ' was talking with ',
      refs.npcs.alberto,
      ', while ',
