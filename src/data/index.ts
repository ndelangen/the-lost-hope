...
export default createCampaign({
  ...
  quests: [
    ...
    quests.what_did_devan_lose_to_the_fiddler,
    quests.inside_swift_s_silver_container,
    quests.bag_of_holding_s_hidden_effect,
    quests.what_is_up_with_bob_the_merchant,
    quests.who_became_swift_starblade_s_enemy,
  ...
  sessions: [
    ...
    sessions.lost_hope_and_lost_tears,
  ],
})
